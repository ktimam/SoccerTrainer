...
def load_wasm(wasm_path: Path) -> binaryen.Module:
...
def remove_exports_of_globals(module: binaryen.Module) -> None:
...
def optimize(
    module: binaryen.Module, shrink_level: int, optimize_level: int
) -> None:
    """Optimize the wasm"""
...
def write_wasm(module: binaryen.Module, wasm_path: Path) -> None:
...
def main() -> None:
    ...
    optimize(module, shrink_level=2, optimize_level=2)
